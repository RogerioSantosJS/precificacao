            ...
            store: Ext.create('Ext.data.Store', {
                ...
                listeners: {
                    load: function(store, records, successful){
                        ...
                        form.down('[name=preco]').setValue(me.solicitacao.get('precoPara'));
                        form.down('[name=mb]').setValue(r.get('nmb'));
                        form.down('combobox[name=desconto]').select(r.get('descontoLetra'));
    ...
    buildForm: function(){
        ...
        var cmp = {
            ...
            // items: [
                ...
                // { fieldLabel: 'Custo', name: 'custo' },
                // { fieldLabel: 'Preço', name: 'preco' },
                // { fieldLabel: 'Margem', name: 'margem' },
                // { fieldLabel: 'Desconto', name: 'desconto' },
                // { fieldLabel: 'Margem Mínima', name: 'margemMinima' },
