 ...
 */
class DispositivoSolicitacaoStatus extends \Api\Entity\DispositivoSolicitacaoStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DispositivoSolicitacaoStatus $proxy) {
