 ...
 */
class Pessoa extends \Api\Entity\Pessoa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nome', 'dataCadastro', 'enderecos'];
        }
    ...
    public function addEnderecos(\Doctrine\Common\Collections\Collection $enderecos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEnderecos', [$enderecos]);
    ...
    public function removeEnderecos(\Doctrine\Common\Collections\Collection $enderecos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeEnderecos', [$enderecos]);
